...
`;
         ...
         <div class="delivery-option js-delivery-option" data-product-id="${
           matchingProduct.id
            ...
            <div>
                ...
                <div class="delivery-option-price">${priceString} Delivery Fee</div>
            </div>
        </div>
        `;
    });
  ...
  //     cart.forEach((cartItem) => {
  //         totalOfQuantity += cartItem.quantity;
  //     });
  //     document.querySelector(".js-quantity").innerHTML = `${totalOfQuantity} items`;
  // }
