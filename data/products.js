...
//     //at this point, the object2 is not created yet, so this. doesent have anything to point to yet and this will be undefined
// };

//BUILT-IN DATE CLASS PRACTICES
...
const testObj = {
    ...
    user() {
        console.log(
            `Hello, your name is ${this.name} and you are ${this.age} years old.`
        );
    },
};
